...
object HorizontalPodAutoscalerSpec {
  implicit val `io.k8s.api.autoscaling.v2beta2.HorizontalPodAutoscalerSpec-Decoder`
      : Decoder[HorizontalPodAutoscalerSpec] = deriveDecoder
  implicit val `io.k8s.api.autoscaling.v2beta2.HorizontalPodAutoscalerSpec-Encoder`
