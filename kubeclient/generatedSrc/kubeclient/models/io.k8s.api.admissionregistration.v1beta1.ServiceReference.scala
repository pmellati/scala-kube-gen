...
object ServiceReference {
  implicit val `io.k8s.api.admissionregistration.v1beta1.ServiceReference-Decoder`
      : Decoder[ServiceReference] = deriveDecoder
  implicit val `io.k8s.api.admissionregistration.v1beta1.ServiceReference-Encoder`
