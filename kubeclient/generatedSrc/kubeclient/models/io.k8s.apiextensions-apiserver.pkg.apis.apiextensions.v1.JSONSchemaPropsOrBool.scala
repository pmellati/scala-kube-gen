...
object JSONSchemaPropsOrBool {
  implicit val `io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaPropsOrBool-Decoder`
      : Decoder[JSONSchemaPropsOrBool] =
    decodeJson.map(json => JSONSchemaPropsOrBool(json))

  implicit val `io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaPropsOrBool-Encoder`
