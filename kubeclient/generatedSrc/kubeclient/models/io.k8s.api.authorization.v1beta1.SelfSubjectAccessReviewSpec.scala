...
object SelfSubjectAccessReviewSpec {
  implicit val `io.k8s.api.authorization.v1beta1.SelfSubjectAccessReviewSpec-Decoder`
      : Decoder[SelfSubjectAccessReviewSpec] = deriveDecoder
  implicit val `io.k8s.api.authorization.v1beta1.SelfSubjectAccessReviewSpec-Encoder`
