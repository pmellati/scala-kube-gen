package kubeclient.io.k8s.api.scheduling.v1
...
object PriorityClassList {
  implicit val `io.k8s.api.scheduling.v1.PriorityClassList-Decoder`
      : Decoder[PriorityClassList] = deriveDecoder
  implicit val `io.k8s.api.scheduling.v1.PriorityClassList-Encoder`
