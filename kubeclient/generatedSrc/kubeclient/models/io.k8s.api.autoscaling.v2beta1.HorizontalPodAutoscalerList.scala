...
object HorizontalPodAutoscalerList {
  implicit val `io.k8s.api.autoscaling.v2beta1.HorizontalPodAutoscalerList-Decoder`
      : Decoder[HorizontalPodAutoscalerList] = deriveDecoder
  implicit val `io.k8s.api.autoscaling.v2beta1.HorizontalPodAutoscalerList-Encoder`
