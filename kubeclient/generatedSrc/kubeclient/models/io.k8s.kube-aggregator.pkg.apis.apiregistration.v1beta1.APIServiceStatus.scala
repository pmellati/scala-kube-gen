...
object APIServiceStatus {
  implicit val `io.k8s.kube-aggregator.pkg.apis.apiregistration.v1beta1.APIServiceStatus-Decoder`
      : Decoder[APIServiceStatus] = deriveDecoder
  implicit val `io.k8s.kube-aggregator.pkg.apis.apiregistration.v1beta1.APIServiceStatus-Encoder`
