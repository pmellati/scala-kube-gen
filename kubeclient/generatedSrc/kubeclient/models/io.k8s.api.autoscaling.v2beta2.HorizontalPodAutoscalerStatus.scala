...
object HorizontalPodAutoscalerStatus {
  implicit val `io.k8s.api.autoscaling.v2beta2.HorizontalPodAutoscalerStatus-Decoder`
      : Decoder[HorizontalPodAutoscalerStatus] = deriveDecoder
  implicit val `io.k8s.api.autoscaling.v2beta2.HorizontalPodAutoscalerStatus-Encoder`
