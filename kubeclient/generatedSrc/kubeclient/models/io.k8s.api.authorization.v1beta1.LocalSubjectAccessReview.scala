...
object LocalSubjectAccessReview {
  implicit val `io.k8s.api.authorization.v1beta1.LocalSubjectAccessReview-Decoder`
      : Decoder[LocalSubjectAccessReview] = deriveDecoder
  implicit val `io.k8s.api.authorization.v1beta1.LocalSubjectAccessReview-Encoder`
