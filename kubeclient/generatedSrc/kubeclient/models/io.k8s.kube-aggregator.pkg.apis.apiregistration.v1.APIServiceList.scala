...
object APIServiceList {
  implicit val `io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIServiceList-Decoder`
      : Decoder[APIServiceList] = deriveDecoder
  implicit val `io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIServiceList-Encoder`
