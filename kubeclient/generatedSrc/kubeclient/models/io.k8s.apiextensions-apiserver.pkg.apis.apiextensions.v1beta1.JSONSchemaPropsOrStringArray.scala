...
object JSONSchemaPropsOrStringArray {
  implicit val `io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1beta1.JSONSchemaPropsOrStringArray-Decoder`
      : Decoder[JSONSchemaPropsOrStringArray] =
    decodeJson.map(json => JSONSchemaPropsOrStringArray(json))

  implicit val `io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1beta1.JSONSchemaPropsOrStringArray-Encoder`
