...
object ValidatingWebhookConfiguration {
  implicit val `io.k8s.api.admissionregistration.v1.ValidatingWebhookConfiguration-Decoder`
      : Decoder[ValidatingWebhookConfiguration] = deriveDecoder
  implicit val `io.k8s.api.admissionregistration.v1.ValidatingWebhookConfiguration-Encoder`
