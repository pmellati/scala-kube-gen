...
object JSONSchemaPropsOrArray {
  implicit val `io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1beta1.JSONSchemaPropsOrArray-Decoder`
      : Decoder[JSONSchemaPropsOrArray] =
    decodeJson.map(json => JSONSchemaPropsOrArray(json))

  implicit val `io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1beta1.JSONSchemaPropsOrArray-Encoder`
