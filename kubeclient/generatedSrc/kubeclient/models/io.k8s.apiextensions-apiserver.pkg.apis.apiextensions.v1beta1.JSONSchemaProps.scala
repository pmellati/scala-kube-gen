...
object JSONSchemaProps {
  implicit val `io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1beta1.JSONSchemaProps-Decoder`
      : Decoder[JSONSchemaProps] = deriveDecoder
  implicit val `io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1beta1.JSONSchemaProps-Encoder`
