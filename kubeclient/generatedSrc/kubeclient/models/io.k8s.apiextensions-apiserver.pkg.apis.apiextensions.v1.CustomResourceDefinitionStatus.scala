...
object CustomResourceDefinitionStatus {
  implicit val `io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.CustomResourceDefinitionStatus-Decoder`
      : Decoder[CustomResourceDefinitionStatus] = deriveDecoder
  implicit val `io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.CustomResourceDefinitionStatus-Encoder`
