...
object APIService {
  implicit val `io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIService-Decoder`
      : Decoder[APIService] = deriveDecoder
  implicit val `io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIService-Encoder`
