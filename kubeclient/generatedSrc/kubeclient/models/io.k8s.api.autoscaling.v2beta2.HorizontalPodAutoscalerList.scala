...
object HorizontalPodAutoscalerList {
  implicit val `io.k8s.api.autoscaling.v2beta2.HorizontalPodAutoscalerList-Decoder`
      : Decoder[HorizontalPodAutoscalerList] = deriveDecoder
  implicit val `io.k8s.api.autoscaling.v2beta2.HorizontalPodAutoscalerList-Encoder`
