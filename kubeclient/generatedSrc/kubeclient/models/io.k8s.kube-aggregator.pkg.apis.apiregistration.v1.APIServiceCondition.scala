...
object APIServiceCondition {
  implicit val `io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIServiceCondition-Decoder`
      : Decoder[APIServiceCondition] = deriveDecoder
  implicit val `io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIServiceCondition-Encoder`
