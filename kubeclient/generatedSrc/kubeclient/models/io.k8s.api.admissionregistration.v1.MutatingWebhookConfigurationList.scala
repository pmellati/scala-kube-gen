...
object MutatingWebhookConfigurationList {
  implicit val `io.k8s.api.admissionregistration.v1.MutatingWebhookConfigurationList-Decoder`
      : Decoder[MutatingWebhookConfigurationList] = deriveDecoder
  implicit val `io.k8s.api.admissionregistration.v1.MutatingWebhookConfigurationList-Encoder`
