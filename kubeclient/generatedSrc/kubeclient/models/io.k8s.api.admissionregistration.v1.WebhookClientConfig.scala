...
object WebhookClientConfig {
  implicit val `io.k8s.api.admissionregistration.v1.WebhookClientConfig-Decoder`
      : Decoder[WebhookClientConfig] = deriveDecoder
  implicit val `io.k8s.api.admissionregistration.v1.WebhookClientConfig-Encoder`
