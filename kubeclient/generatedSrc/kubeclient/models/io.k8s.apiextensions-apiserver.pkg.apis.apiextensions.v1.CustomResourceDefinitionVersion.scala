...
object CustomResourceDefinitionVersion {
  implicit val `io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.CustomResourceDefinitionVersion-Decoder`
      : Decoder[CustomResourceDefinitionVersion] = deriveDecoder
  implicit val `io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.CustomResourceDefinitionVersion-Encoder`
