...
object RunAsGroupStrategyOptions {
  implicit val `io.k8s.api.extensions.v1beta1.RunAsGroupStrategyOptions-Decoder`
      : Decoder[RunAsGroupStrategyOptions] = deriveDecoder
  implicit val `io.k8s.api.extensions.v1beta1.RunAsGroupStrategyOptions-Encoder`
