...
object SubjectAccessReviewStatus {
  implicit val `io.k8s.api.authorization.v1beta1.SubjectAccessReviewStatus-Decoder`
      : Decoder[SubjectAccessReviewStatus] = deriveDecoder
  implicit val `io.k8s.api.authorization.v1beta1.SubjectAccessReviewStatus-Encoder`
