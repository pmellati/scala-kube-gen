...
object ExternalDocumentation {
  implicit val `io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.ExternalDocumentation-Decoder`
      : Decoder[ExternalDocumentation] = deriveDecoder
  implicit val `io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.ExternalDocumentation-Encoder`
