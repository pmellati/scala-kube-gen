...
object WebhookClientConfig {
  implicit val `io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1beta1.WebhookClientConfig-Decoder`
      : Decoder[WebhookClientConfig] = deriveDecoder
  implicit val `io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1beta1.WebhookClientConfig-Encoder`
