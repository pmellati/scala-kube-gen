...
object HorizontalPodAutoscaler {
  implicit val `io.k8s.api.autoscaling.v2beta1.HorizontalPodAutoscaler-Decoder`
      : Decoder[HorizontalPodAutoscaler] = deriveDecoder
  implicit val `io.k8s.api.autoscaling.v2beta1.HorizontalPodAutoscaler-Encoder`
