...
object MutatingWebhookConfiguration {
  implicit val `io.k8s.api.admissionregistration.v1beta1.MutatingWebhookConfiguration-Decoder`
      : Decoder[MutatingWebhookConfiguration] = deriveDecoder
  implicit val `io.k8s.api.admissionregistration.v1beta1.MutatingWebhookConfiguration-Encoder`
