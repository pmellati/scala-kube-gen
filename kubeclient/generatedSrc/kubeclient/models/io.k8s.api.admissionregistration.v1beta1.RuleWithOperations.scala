...
object RuleWithOperations {
  implicit val `io.k8s.api.admissionregistration.v1beta1.RuleWithOperations-Decoder`
      : Decoder[RuleWithOperations] = deriveDecoder
  implicit val `io.k8s.api.admissionregistration.v1beta1.RuleWithOperations-Encoder`
