...
object ValidatingWebhookConfigurationList {
  implicit val `io.k8s.api.admissionregistration.v1beta1.ValidatingWebhookConfigurationList-Decoder`
      : Decoder[ValidatingWebhookConfigurationList] = deriveDecoder
  implicit val `io.k8s.api.admissionregistration.v1beta1.ValidatingWebhookConfigurationList-Encoder`
