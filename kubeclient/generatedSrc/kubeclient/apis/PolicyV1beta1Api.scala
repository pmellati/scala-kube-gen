...
import kubeclient.io.k8s.api.policy.v1beta1.PodDisruptionBudget
import kubeclient.io.k8s.api.policy.v1beta1.PodDisruptionBudgetList
import kubeclient.io.k8s.api.policy.v1beta1.PodSecurityPolicy
import kubeclient.io.k8s.api.policy.v1beta1.PodSecurityPolicyList
...
object PolicyV1beta1Api {
  ...
  /** get available resources
    ...
    */
  def getPolicyV1beta1APIResources[F[_]: Applicative: Sync]
      : Action[F, APIResourceList] = Kleisli { _config =>
    val _path = s"""/apis/policy/v1beta1/"""
...
The server guarantees that the objects returned when using continue will be identical to issuing a single list call without a limit - that is, no objects created, modified, or deleted after the first request is issued will be included in any subsequent continued requests. This is sometimes referred to as a consistent snapshot, and ensures that a client that is using limit to receive smaller chunks of a very large result can ensure they see all possible objects. If objects are updated during a chunked list the version of the object that was present at the time the first list result was calculated is returned.
    ...
    */
  def listPolicyV1beta1NamespacedPodDisruptionBudget[F[_]: Applicative: Sync](
      namespace: String,
  ...
  ): Action[F, PodDisruptionBudgetList] = Kleisli { _config =>
    val _path =
      s"""/apis/policy/v1beta1/namespaces/${namespace}/poddisruptionbudgets"""
    val _uri = _config.baseApiUri.withPath(_path)
    ...
    _config.httpClient.expect[PodDisruptionBudgetList](_request)
  }
  ...
  /** create a PodDisruptionBudget
    ...
    */
  def createPolicyV1beta1NamespacedPodDisruptionBudget[F[_]: Applicative: Sync](
      namespace: String,
      pretty: Option[String] = None,
      body: PodDisruptionBudget,
      dryRun: Option[String] = None,
      fieldManager: Option[String] = None
  ): Action[F, PodDisruptionBudget] = Kleisli { _config =>
    val _path =
      s"""/apis/policy/v1beta1/namespaces/${namespace}/poddisruptionbudgets"""
    val _uri = _config.baseApiUri.withPath(_path)
    ...
    _config.httpClient.expect[PodDisruptionBudget](_request)
  }
...
The server guarantees that the objects returned when using continue will be identical to issuing a single list call without a limit - that is, no objects created, modified, or deleted after the first request is issued will be included in any subsequent continued requests. This is sometimes referred to as a consistent snapshot, and ensures that a client that is using limit to receive smaller chunks of a very large result can ensure they see all possible objects. If objects are updated during a chunked list the version of the object that was present at the time the first list result was calculated is returned.
    ...
    *  @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    */
  def deletePolicyV1beta1CollectionNamespacedPodDisruptionBudget[F[_]: Applicative: Sync](
      namespace: String,
      pretty: Option[String] = None,
      allowWatchBookmarks: Option[Boolean] = None,
  ...
  /** read the specified PodDisruptionBudget
    ...
    */
  def readPolicyV1beta1NamespacedPodDisruptionBudget[F[_]: Applicative: Sync](
      name: String,
      namespace: String,
      pretty: Option[String] = None,
    ...
    val _path =
      s"""/apis/policy/v1beta1/namespaces/${namespace}/poddisruptionbudgets/${name}"""
    val _uri = _config.baseApiUri.withPath(_path)
  ...
  /** replace the specified PodDisruptionBudget
    ...
    *  @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
    */
  def replacePolicyV1beta1NamespacedPodDisruptionBudget[F[_]: Applicative: Sync](
      name: String,
      namespace: String,
      pretty: Option[String] = None,
      body: PodDisruptionBudget,
  ...
  /** delete a PodDisruptionBudget
    ...
    *  @param propagationPolicy Whether and how garbage collection will be performed. Either this field or OrphanDependents may be set, but not both. The default policy is decided by the existing finalizer set in the metadata.finalizers and the resource-specific default policy. Acceptable values are: 'Orphan' - orphan the dependents; 'Background' - allow the garbage collector to delete the dependents in the background; 'Foreground' - a cascading policy that deletes all dependents in the foreground.
    */
  def deletePolicyV1beta1NamespacedPodDisruptionBudget[F[_]: Applicative: Sync](
      name: String,
      namespace: String,
      pretty: Option[String] = None,
      body: Option[DeleteOptions] = None,
  ...
  /** partially update the specified PodDisruptionBudget
    ...
    */
  def patchPolicyV1beta1NamespacedPodDisruptionBudget[F[_]: Applicative: Sync](
      name: String,
      namespace: String,
      pretty: Option[String] = None,
      body: Patch,
  ...
  /** read status of the specified PodDisruptionBudget
    ...
    *  @param pretty If 'true', then the output is pretty printed.
    */
  def readPolicyV1beta1NamespacedPodDisruptionBudgetStatus[F[_]: Applicative: Sync](
      name: String,
      namespace: String,
      pretty: Option[String] = None
  ): Action[F, PodDisruptionBudget] = Kleisli { _config =>
    val _path =
      s"""/apis/policy/v1beta1/namespaces/${namespace}/poddisruptionbudgets/${name}/status"""
    val _uri = _config.baseApiUri.withPath(_path)
  ...
  /** replace status of the specified PodDisruptionBudget
    ...
    *  @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
    */
  def replacePolicyV1beta1NamespacedPodDisruptionBudgetStatus[F[_]: Applicative: Sync](
      name: String,
      namespace: String,
      pretty: Option[String] = None,
      body: PodDisruptionBudget,
  ...
  /** partially update status of the specified PodDisruptionBudget
    ...
    *  @param force Force is going to "force" Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
    */
  def patchPolicyV1beta1NamespacedPodDisruptionBudgetStatus[F[_]: Applicative: Sync](
      name: String,
      namespace: String,
      pretty: Option[String] = None,
      body: Patch,
...
The server guarantees that the objects returned when using continue will be identical to issuing a single list call without a limit - that is, no objects created, modified, or deleted after the first request is issued will be included in any subsequent continued requests. This is sometimes referred to as a consistent snapshot, and ensures that a client that is using limit to receive smaller chunks of a very large result can ensure they see all possible objects. If objects are updated during a chunked list the version of the object that was present at the time the first list result was calculated is returned.
    ...
    *  @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    */
  def listPolicyV1beta1PodDisruptionBudgetForAllNamespaces[F[_]: Applicative: Sync](
      allowWatchBookmarks: Option[Boolean] = None,
      continue: Option[String] = None,
      fieldSelector: Option[String] = None,
      labelSelector: Option[String] = None,
    ...
    val _path = s"""/apis/policy/v1beta1/poddisruptionbudgets"""
    val _uri  = _config.baseApiUri.withPath(_path)
...
The server guarantees that the objects returned when using continue will be identical to issuing a single list call without a limit - that is, no objects created, modified, or deleted after the first request is issued will be included in any subsequent continued requests. This is sometimes referred to as a consistent snapshot, and ensures that a client that is using limit to receive smaller chunks of a very large result can ensure they see all possible objects. If objects are updated during a chunked list the version of the object that was present at the time the first list result was calculated is returned.
    ...
    *  @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    */
  def listPolicyV1beta1PodSecurityPolicy[F[_]: Applicative: Sync](
      pretty: Option[String] = None,
      allowWatchBookmarks: Option[Boolean] = None,
      continue: Option[String] = None,
      fieldSelector: Option[String] = None,
    ...
    val _path = s"""/apis/policy/v1beta1/podsecuritypolicies"""
    val _uri  = _config.baseApiUri.withPath(_path)
  ...
  /** create a PodSecurityPolicy
    ...
    *  @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
    */
  def createPolicyV1beta1PodSecurityPolicy[F[_]: Applicative: Sync](
      pretty: Option[String] = None,
...
The server guarantees that the objects returned when using continue will be identical to issuing a single list call without a limit - that is, no objects created, modified, or deleted after the first request is issued will be included in any subsequent continued requests. This is sometimes referred to as a consistent snapshot, and ensures that a client that is using limit to receive smaller chunks of a very large result can ensure they see all possible objects. If objects are updated during a chunked list the version of the object that was present at the time the first list result was calculated is returned.
    ...
    *  @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    */
  def deletePolicyV1beta1CollectionPodSecurityPolicy[F[_]: Applicative: Sync](
      pretty: Option[String] = None,
      allowWatchBookmarks: Option[Boolean] = None,
      body: Option[DeleteOptions] = None,
      continue: Option[String] = None,
  ...
  /** read the specified PodSecurityPolicy
    ...
    *  @param export Should this value be exported.  Export strips fields that a user can not specify. Deprecated. Planned for removal in 1.18.
    */
  def readPolicyV1beta1PodSecurityPolicy[F[_]: Applicative: Sync](
      name: String,
      pretty: Option[String] = None,
      exact: Option[Boolean] = None,
      export: Option[Boolean] = None
  ): Action[F, PodSecurityPolicy] = Kleisli { _config =>
    val _path = s"""/apis/policy/v1beta1/podsecuritypolicies/${name}"""
    val _uri  = _config.baseApiUri.withPath(_path)
  ...
  /** replace the specified PodSecurityPolicy
    ...
    *  @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
    */
  def replacePolicyV1beta1PodSecurityPolicy[F[_]: Applicative: Sync](
      name: String,
      pretty: Option[String] = None,
      body: PodSecurityPolicy,
      dryRun: Option[String] = None,
  ...
  /** delete a PodSecurityPolicy
    ...
    *  @param propagationPolicy Whether and how garbage collection will be performed. Either this field or OrphanDependents may be set, but not both. The default policy is decided by the existing finalizer set in the metadata.finalizers and the resource-specific default policy. Acceptable values are: 'Orphan' - orphan the dependents; 'Background' - allow the garbage collector to delete the dependents in the background; 'Foreground' - a cascading policy that deletes all dependents in the foreground.
    */
  def deletePolicyV1beta1PodSecurityPolicy[F[_]: Applicative: Sync](
      name: String,
      pretty: Option[String] = None,
      body: Option[DeleteOptions] = None,
      dryRun: Option[String] = None,
  ...
  /** partially update the specified PodSecurityPolicy
    ...
    *  @param force Force is going to "force" Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
    */
  def patchPolicyV1beta1PodSecurityPolicy[F[_]: Applicative: Sync](
      name: String,
      pretty: Option[String] = None,
      body: Patch,
      dryRun: Option[String] = None,
...
The server guarantees that the objects returned when using continue will be identical to issuing a single list call without a limit - that is, no objects created, modified, or deleted after the first request is issued will be included in any subsequent continued requests. This is sometimes referred to as a consistent snapshot, and ensures that a client that is using limit to receive smaller chunks of a very large result can ensure they see all possible objects. If objects are updated during a chunked list the version of the object that was present at the time the first list result was calculated is returned.
    ...
    *  @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    */
  def watchPolicyV1beta1NamespacedPodDisruptionBudgetList[F[_]: Applicative: Sync](
      allowWatchBookmarks: Option[Boolean] = None,
      continue: Option[String] = None,
      fieldSelector: Option[String] = None,
      labelSelector: Option[String] = None,
    ...
    val _path =
      s"""/apis/policy/v1beta1/watch/namespaces/${namespace}/poddisruptionbudgets"""
    val _uri = _config.baseApiUri.withPath(_path)
...
The server guarantees that the objects returned when using continue will be identical to issuing a single list call without a limit - that is, no objects created, modified, or deleted after the first request is issued will be included in any subsequent continued requests. This is sometimes referred to as a consistent snapshot, and ensures that a client that is using limit to receive smaller chunks of a very large result can ensure they see all possible objects. If objects are updated during a chunked list the version of the object that was present at the time the first list result was calculated is returned.
    ...
    *  @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    */
  def watchPolicyV1beta1NamespacedPodDisruptionBudget[F[_]: Applicative: Sync](
      allowWatchBookmarks: Option[Boolean] = None,
      continue: Option[String] = None,
      fieldSelector: Option[String] = None,
      labelSelector: Option[String] = None,
    ...
    val _path =
      s"""/apis/policy/v1beta1/watch/namespaces/${namespace}/poddisruptionbudgets/${name}"""
    val _uri = _config.baseApiUri.withPath(_path)
...
The server guarantees that the objects returned when using continue will be identical to issuing a single list call without a limit - that is, no objects created, modified, or deleted after the first request is issued will be included in any subsequent continued requests. This is sometimes referred to as a consistent snapshot, and ensures that a client that is using limit to receive smaller chunks of a very large result can ensure they see all possible objects. If objects are updated during a chunked list the version of the object that was present at the time the first list result was calculated is returned.
    ...
    *  @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    */
  def watchPolicyV1beta1PodDisruptionBudgetListForAllNamespaces[F[_]: Applicative: Sync](
      allowWatchBookmarks: Option[Boolean] = None,
      continue: Option[String] = None,
      fieldSelector: Option[String] = None,
      labelSelector: Option[String] = None,
    ...
    val _path = s"""/apis/policy/v1beta1/watch/poddisruptionbudgets"""
    val _uri  = _config.baseApiUri.withPath(_path)
...
The server guarantees that the objects returned when using continue will be identical to issuing a single list call without a limit - that is, no objects created, modified, or deleted after the first request is issued will be included in any subsequent continued requests. This is sometimes referred to as a consistent snapshot, and ensures that a client that is using limit to receive smaller chunks of a very large result can ensure they see all possible objects. If objects are updated during a chunked list the version of the object that was present at the time the first list result was calculated is returned.
    ...
    *  @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    */
  def watchPolicyV1beta1PodSecurityPolicyList[F[_]: Applicative: Sync](
      allowWatchBookmarks: Option[Boolean] = None,
      continue: Option[String] = None,
      fieldSelector: Option[String] = None,
      labelSelector: Option[String] = None,
    ...
    val _path = s"""/apis/policy/v1beta1/watch/podsecuritypolicies"""
    val _uri  = _config.baseApiUri.withPath(_path)
...
The server guarantees that the objects returned when using continue will be identical to issuing a single list call without a limit - that is, no objects created, modified, or deleted after the first request is issued will be included in any subsequent continued requests. This is sometimes referred to as a consistent snapshot, and ensures that a client that is using limit to receive smaller chunks of a very large result can ensure they see all possible objects. If objects are updated during a chunked list the version of the object that was present at the time the first list result was calculated is returned.
    ...
    *  @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    */
  def watchPolicyV1beta1PodSecurityPolicy[F[_]: Applicative: Sync](
      allowWatchBookmarks: Option[Boolean] = None,
      continue: Option[String] = None,
      fieldSelector: Option[String] = None,
      labelSelector: Option[String] = None,
    ...
    val _path = s"""/apis/policy/v1beta1/watch/podsecuritypolicies/${name}"""
    val _uri  = _config.baseApiUri.withPath(_path)
