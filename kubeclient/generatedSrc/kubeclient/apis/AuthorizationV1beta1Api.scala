...
import kubeclient.io.k8s.api.authorization.v1beta1.LocalSubjectAccessReview
import kubeclient.io.k8s.api.authorization.v1beta1.SelfSubjectAccessReview
import kubeclient.io.k8s.api.authorization.v1beta1.SelfSubjectRulesReview
import kubeclient.io.k8s.api.authorization.v1beta1.SubjectAccessReview
...
object AuthorizationV1beta1Api {
  ...
  /** get available resources
    ...
    */
  def getAuthorizationV1beta1APIResources[F[_]: Applicative: Sync]
      : Action[F, APIResourceList] = Kleisli { _config =>
    val _path = s"""/apis/authorization.k8s.io/v1beta1/"""
  ...
  /** create a LocalSubjectAccessReview
    ...
    *  @param body null
    */
  def createAuthorizationV1beta1NamespacedLocalSubjectAccessReview[F[_]: Applicative: Sync](
    ...
    val _path =
      s"""/apis/authorization.k8s.io/v1beta1/namespaces/${namespace}/localsubjectaccessreviews"""
    val _uri = _config.baseApiUri.withPath(_path)
  ...
  /** create a SelfSubjectAccessReview
    ...
    *  @param body null
    */
  def createAuthorizationV1beta1SelfSubjectAccessReview[F[_]: Applicative: Sync](
      dryRun: Option[String] = None,
      fieldManager: Option[String] = None,
      pretty: Option[String] = None,
    ...
    val _path =
      s"""/apis/authorization.k8s.io/v1beta1/selfsubjectaccessreviews"""
    val _uri = _config.baseApiUri.withPath(_path)
  ...
  /** create a SelfSubjectRulesReview
    ...
    *  @param body null
    */
  def createAuthorizationV1beta1SelfSubjectRulesReview[F[_]: Applicative: Sync](
      dryRun: Option[String] = None,
      fieldManager: Option[String] = None,
      pretty: Option[String] = None,
    ...
    val _path =
      s"""/apis/authorization.k8s.io/v1beta1/selfsubjectrulesreviews"""
    val _uri = _config.baseApiUri.withPath(_path)
  ...
  /** create a SubjectAccessReview
    ...
    *  @param body null
    */
  def createAuthorizationV1beta1SubjectAccessReview[F[_]: Applicative: Sync](
      dryRun: Option[String] = None,
      fieldManager: Option[String] = None,
      pretty: Option[String] = None,
      body: SubjectAccessReview
  ): Action[F, SubjectAccessReview] = Kleisli { _config =>
    val _path = s"""/apis/authorization.k8s.io/v1beta1/subjectaccessreviews"""
    val _uri  = _config.baseApiUri.withPath(_path)
