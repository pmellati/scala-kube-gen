...
import kubeclient.io.k8s.api.authentication.v1.TokenReview
...
object AuthenticationV1Api {
  ...
  /** get available resources
    ...
    */
  def getAuthenticationV1APIResources[F[_]: Applicative: Sync]
      : Action[F, APIResourceList] = Kleisli { _config =>
    val _path = s"""/apis/authentication.k8s.io/v1/"""
