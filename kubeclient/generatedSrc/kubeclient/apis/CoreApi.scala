...
import kubeclient.io.k8s.apimachinery.pkg.apis.meta.v1.APIVersions
...
object CoreApi {
  ...
  /** get available API versions
    ...
    */
  def getCoreAPIVersions[F[_]: Applicative: Sync]: Action[F, APIVersions] =
    Kleisli { _config =>
      val _path = s"""/api/"""
      ...
      _config.httpClient.expect[APIVersions](_request)
    }
