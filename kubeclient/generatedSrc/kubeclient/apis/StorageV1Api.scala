...
import kubeclient.io.k8s.api.storage.v1.StorageClass
import kubeclient.io.k8s.api.storage.v1.StorageClassList
import kubeclient.io.k8s.api.storage.v1.VolumeAttachment
import kubeclient.io.k8s.api.storage.v1.VolumeAttachmentList
...
object StorageV1Api {
  ...
  /** get available resources
    ...
    */
  def getStorageV1APIResources[F[_]: Applicative: Sync]
      : Action[F, APIResourceList] = Kleisli { _config =>
    val _path = s"""/apis/storage.k8s.io/v1/"""
...
The server guarantees that the objects returned when using continue will be identical to issuing a single list call without a limit - that is, no objects created, modified, or deleted after the first request is issued will be included in any subsequent continued requests. This is sometimes referred to as a consistent snapshot, and ensures that a client that is using limit to receive smaller chunks of a very large result can ensure they see all possible objects. If objects are updated during a chunked list the version of the object that was present at the time the first list result was calculated is returned.
    ...
    */
  def listStorageV1StorageClass[F[_]: Applicative: Sync](
    ...
    val _path = s"""/apis/storage.k8s.io/v1/storageclasses"""
    val _uri  = _config.baseApiUri.withPath(_path)
  ...
  /** create a StorageClass
    ...
    */
  def createStorageV1StorageClass[F[_]: Applicative: Sync](
      pretty: Option[String] = None,
      body: StorageClass,
...
The server guarantees that the objects returned when using continue will be identical to issuing a single list call without a limit - that is, no objects created, modified, or deleted after the first request is issued will be included in any subsequent continued requests. This is sometimes referred to as a consistent snapshot, and ensures that a client that is using limit to receive smaller chunks of a very large result can ensure they see all possible objects. If objects are updated during a chunked list the version of the object that was present at the time the first list result was calculated is returned.
    ...
    *  @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    */
  def deleteStorageV1CollectionStorageClass[F[_]: Applicative: Sync](
      pretty: Option[String] = None,
      allowWatchBookmarks: Option[Boolean] = None,
  ...
  /** read the specified StorageClass
    ...
    */
  def readStorageV1StorageClass[F[_]: Applicative: Sync](
      name: String,
      pretty: Option[String] = None,
      exact: Option[Boolean] = None,
      export: Option[Boolean] = None
  ): Action[F, StorageClass] = Kleisli { _config =>
    val _path = s"""/apis/storage.k8s.io/v1/storageclasses/${name}"""
    val _uri  = _config.baseApiUri.withPath(_path)
  ...
  /** replace the specified StorageClass
    ...
    *  @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
    */
  def replaceStorageV1StorageClass[F[_]: Applicative: Sync](
      name: String,
      pretty: Option[String] = None,
      body: StorageClass,
      dryRun: Option[String] = None,
  ...
  /** delete a StorageClass
    ...
    *  @param propagationPolicy Whether and how garbage collection will be performed. Either this field or OrphanDependents may be set, but not both. The default policy is decided by the existing finalizer set in the metadata.finalizers and the resource-specific default policy. Acceptable values are: 'Orphan' - orphan the dependents; 'Background' - allow the garbage collector to delete the dependents in the background; 'Foreground' - a cascading policy that deletes all dependents in the foreground.
    */
  def deleteStorageV1StorageClass[F[_]: Applicative: Sync](
      name: String,
      pretty: Option[String] = None,
      body: Option[DeleteOptions] = None,
      dryRun: Option[String] = None,
  ...
  /** partially update the specified StorageClass
    ...
    */
  def patchStorageV1StorageClass[F[_]: Applicative: Sync](
      name: String,
      pretty: Option[String] = None,
      body: Patch,
      dryRun: Option[String] = None,
...
The server guarantees that the objects returned when using continue will be identical to issuing a single list call without a limit - that is, no objects created, modified, or deleted after the first request is issued will be included in any subsequent continued requests. This is sometimes referred to as a consistent snapshot, and ensures that a client that is using limit to receive smaller chunks of a very large result can ensure they see all possible objects. If objects are updated during a chunked list the version of the object that was present at the time the first list result was calculated is returned.
    ...
    *  @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    */
  def listStorageV1VolumeAttachment[F[_]: Applicative: Sync](
      pretty: Option[String] = None,
      allowWatchBookmarks: Option[Boolean] = None,
      continue: Option[String] = None,
      fieldSelector: Option[String] = None,
    ...
    val _path = s"""/apis/storage.k8s.io/v1/volumeattachments"""
    val _uri  = _config.baseApiUri.withPath(_path)
  ...
  /** create a VolumeAttachment
    ...
    *  @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
    */
  def createStorageV1VolumeAttachment[F[_]: Applicative: Sync](
      pretty: Option[String] = None,
...
The server guarantees that the objects returned when using continue will be identical to issuing a single list call without a limit - that is, no objects created, modified, or deleted after the first request is issued will be included in any subsequent continued requests. This is sometimes referred to as a consistent snapshot, and ensures that a client that is using limit to receive smaller chunks of a very large result can ensure they see all possible objects. If objects are updated during a chunked list the version of the object that was present at the time the first list result was calculated is returned.
    ...
    *  @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    */
  def deleteStorageV1CollectionVolumeAttachment[F[_]: Applicative: Sync](
      pretty: Option[String] = None,
      allowWatchBookmarks: Option[Boolean] = None,
      body: Option[DeleteOptions] = None,
      continue: Option[String] = None,
  ...
  /** read the specified VolumeAttachment
    ...
    *  @param export Should this value be exported.  Export strips fields that a user can not specify. Deprecated. Planned for removal in 1.18.
    */
  def readStorageV1VolumeAttachment[F[_]: Applicative: Sync](
      name: String,
      pretty: Option[String] = None,
      exact: Option[Boolean] = None,
      export: Option[Boolean] = None
  ): Action[F, VolumeAttachment] = Kleisli { _config =>
    val _path = s"""/apis/storage.k8s.io/v1/volumeattachments/${name}"""
    val _uri  = _config.baseApiUri.withPath(_path)
  ...
  /** replace the specified VolumeAttachment
    ...
    *  @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
    */
  def replaceStorageV1VolumeAttachment[F[_]: Applicative: Sync](
      name: String,
      pretty: Option[String] = None,
      body: VolumeAttachment,
      dryRun: Option[String] = None,
  ...
  /** delete a VolumeAttachment
    ...
    *  @param propagationPolicy Whether and how garbage collection will be performed. Either this field or OrphanDependents may be set, but not both. The default policy is decided by the existing finalizer set in the metadata.finalizers and the resource-specific default policy. Acceptable values are: 'Orphan' - orphan the dependents; 'Background' - allow the garbage collector to delete the dependents in the background; 'Foreground' - a cascading policy that deletes all dependents in the foreground.
    */
  def deleteStorageV1VolumeAttachment[F[_]: Applicative: Sync](
      name: String,
      pretty: Option[String] = None,
      body: Option[DeleteOptions] = None,
      dryRun: Option[String] = None,
  ...
  /** partially update the specified VolumeAttachment
    ...
    *  @param force Force is going to "force" Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
    */
  def patchStorageV1VolumeAttachment[F[_]: Applicative: Sync](
      name: String,
      pretty: Option[String] = None,
      body: Patch,
      dryRun: Option[String] = None,
  ...
  /** read status of the specified VolumeAttachment
    ...
    *  @param pretty If 'true', then the output is pretty printed.
    */
  def readStorageV1VolumeAttachmentStatus[F[_]: Applicative: Sync](
      name: String,
      pretty: Option[String] = None
  ): Action[F, VolumeAttachment] = Kleisli { _config =>
    val _path = s"""/apis/storage.k8s.io/v1/volumeattachments/${name}/status"""
    val _uri  = _config.baseApiUri.withPath(_path)
  ...
  /** replace status of the specified VolumeAttachment
    ...
    *  @param fieldManager fieldManager is a name associated with the actor or entity that is making these changes. The value must be less than or 128 characters long, and only contain printable characters, as defined by https://golang.org/pkg/unicode/#IsPrint.
    */
  def replaceStorageV1VolumeAttachmentStatus[F[_]: Applicative: Sync](
      name: String,
      pretty: Option[String] = None,
      body: VolumeAttachment,
      dryRun: Option[String] = None,
  ...
  /** partially update status of the specified VolumeAttachment
    ...
    *  @param force Force is going to "force" Apply requests. It means user will re-acquire conflicting fields owned by other people. Force flag must be unset for non-apply patch requests.
    */
  def patchStorageV1VolumeAttachmentStatus[F[_]: Applicative: Sync](
      name: String,
      pretty: Option[String] = None,
      body: Patch,
      dryRun: Option[String] = None,
...
The server guarantees that the objects returned when using continue will be identical to issuing a single list call without a limit - that is, no objects created, modified, or deleted after the first request is issued will be included in any subsequent continued requests. This is sometimes referred to as a consistent snapshot, and ensures that a client that is using limit to receive smaller chunks of a very large result can ensure they see all possible objects. If objects are updated during a chunked list the version of the object that was present at the time the first list result was calculated is returned.
    ...
    *  @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    */
  def watchStorageV1StorageClassList[F[_]: Applicative: Sync](
      allowWatchBookmarks: Option[Boolean] = None,
      continue: Option[String] = None,
      fieldSelector: Option[String] = None,
      labelSelector: Option[String] = None,
    ...
    val _path = s"""/apis/storage.k8s.io/v1/watch/storageclasses"""
    val _uri  = _config.baseApiUri.withPath(_path)
...
The server guarantees that the objects returned when using continue will be identical to issuing a single list call without a limit - that is, no objects created, modified, or deleted after the first request is issued will be included in any subsequent continued requests. This is sometimes referred to as a consistent snapshot, and ensures that a client that is using limit to receive smaller chunks of a very large result can ensure they see all possible objects. If objects are updated during a chunked list the version of the object that was present at the time the first list result was calculated is returned.
    ...
    *  @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    */
  def watchStorageV1StorageClass[F[_]: Applicative: Sync](
      allowWatchBookmarks: Option[Boolean] = None,
      continue: Option[String] = None,
      fieldSelector: Option[String] = None,
      labelSelector: Option[String] = None,
    ...
    val _path = s"""/apis/storage.k8s.io/v1/watch/storageclasses/${name}"""
    val _uri  = _config.baseApiUri.withPath(_path)
...
The server guarantees that the objects returned when using continue will be identical to issuing a single list call without a limit - that is, no objects created, modified, or deleted after the first request is issued will be included in any subsequent continued requests. This is sometimes referred to as a consistent snapshot, and ensures that a client that is using limit to receive smaller chunks of a very large result can ensure they see all possible objects. If objects are updated during a chunked list the version of the object that was present at the time the first list result was calculated is returned.
    ...
    *  @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    */
  def watchStorageV1VolumeAttachmentList[F[_]: Applicative: Sync](
      allowWatchBookmarks: Option[Boolean] = None,
      continue: Option[String] = None,
      fieldSelector: Option[String] = None,
      labelSelector: Option[String] = None,
    ...
    val _path = s"""/apis/storage.k8s.io/v1/watch/volumeattachments"""
    val _uri  = _config.baseApiUri.withPath(_path)
...
The server guarantees that the objects returned when using continue will be identical to issuing a single list call without a limit - that is, no objects created, modified, or deleted after the first request is issued will be included in any subsequent continued requests. This is sometimes referred to as a consistent snapshot, and ensures that a client that is using limit to receive smaller chunks of a very large result can ensure they see all possible objects. If objects are updated during a chunked list the version of the object that was present at the time the first list result was calculated is returned.
    ...
    *  @param watch Watch for changes to the described resources and return them as a stream of add, update, and remove notifications. Specify resourceVersion.
    */
  def watchStorageV1VolumeAttachment[F[_]: Applicative: Sync](
      allowWatchBookmarks: Option[Boolean] = None,
      continue: Option[String] = None,
      fieldSelector: Option[String] = None,
      labelSelector: Option[String] = None,
    ...
    val _path = s"""/apis/storage.k8s.io/v1/watch/volumeattachments/${name}"""
    val _uri  = _config.baseApiUri.withPath(_path)
