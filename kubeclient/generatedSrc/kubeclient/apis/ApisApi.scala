...
import kubeclient.io.k8s.apimachinery.pkg.apis.meta.v1.APIGroupList
...
object ApisApi {
  ...
  /** get available API versions
    ...
    */
  def getAPIVersions[F[_]: Applicative: Sync]: Action[F, APIGroupList] =
    Kleisli { _config =>
      val _path = s"""/apis/"""
      ...
      _config.httpClient.expect[APIGroupList](_request)
    }
