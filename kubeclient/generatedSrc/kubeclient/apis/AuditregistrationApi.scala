...
object AuditregistrationApi {
  ...
  /** get information of a group
    ...
    */
  def getAuditregistrationAPIGroup[F[_]: Applicative: Sync]
      : Action[F, APIGroup] = Kleisli { _config =>
    val _path = s"""/apis/auditregistration.k8s.io/"""
